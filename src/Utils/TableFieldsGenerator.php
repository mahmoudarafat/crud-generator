...
namespace AlBadrSystems\Generator\Utils;

use DB;
use Doctrine\DBAL\Schema\AbstractSchemaManager;
use Doctrine\DBAL\Schema\Column;
use Illuminate\Support\Str;
use AlBadrSystems\Generator\Common\GeneratorField;
use AlBadrSystems\Generator\Common\GeneratorFieldRelation;
...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName, $ignoredFields, $connection = '')
    {
        ...
        $mappings = config('albadrsystems.laravel_generator.from_table.doctrine_mappings', []);
        ...
        $this->defaultSearchable = config('albadrsystems.laravel_generator.options.tables_searchable_default', false);
    }
    ...
    {
        if (!config('albadrsystems.laravel_generator.timestamps.enabled', true)) {
            return [];
        }

        $createdAtName = config('albadrsystems.laravel_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('albadrsystems.laravel_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('albadrsystems.laravel_generator.timestamps.deleted_at', 'deleted_at');
