...
namespace AlBadrSystems\Generator\Generators\Scaffold;

use AlBadrSystems\Generator\Common\CommandData;
use AlBadrSystems\Generator\Generators\BaseGenerator;
...
class RequestGenerator extends BaseGenerator
{
    ...
    {
        $templateData = get_template('scaffold.request.create_request', 'crud-generator');
