...
use AlBadrSystems\Generator\Events\GeneratorFileCreated;
use AlBadrSystems\Generator\Events\GeneratorFileCreating;
use AlBadrSystems\Generator\Events\GeneratorFileDeleted;
use AlBadrSystems\Generator\Events\GeneratorFileDeleting;
use AlBadrSystems\Generator\Utils\FileUtil;
use AlBadrSystems\Generator\Utils\GeneratorFieldsInputUtil;
use AlBadrSystems\Generator\Utils\TableFieldsGenerator;
            ...
            if ($this->getOption('fieldsFile')) {
                ...
                if (file_exists($fieldsFileValue)) {
                    ...
                    $schemaFileDirector = config(
                        'albadrsystems.laravel_generator.path.schema_files',
